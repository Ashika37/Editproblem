  ...
  <nav>
	...
	<br>
		...
		<div style="margin-right:10px;width:50%">
					<label>From</label>
					<br>
         		<select id="subject1" class="form-control1 css1" onchange="updateSelect(this,'subject2');" name="indication_subject[];">
		...
		<div style="margin-left: 10px;width: 50%">
					<label>To</label>
          		<select id="subject2" class="form-control1 css1" onchange="updateSelect(this,'subject1');" name="indication_subject[];">
					<option value="selected">Select</option>
					<option value="1">Delhi</option>
					<option value="2">Jaipur</option>
					<option value="3">Agra</option>
